# TEND submission copy

Use this file when filling the Creative Minds Jam submission form. Replace bracketed links only after deployment and recording.

## One-line pitch

TEND is a persistent Discord community steward that remembers creator values and member-stated boundaries, proposes proportionate repair, and follows up without another creator prompt.

## Short description

Moderation should not reset with every message. TEND gives independent creators a persistent Mind that connects new incidents to community culture, approved memory receipts, and prior outcomes. It recommends the least invasive effective response, keeps consequential actions behind human approval, and returns later through a real persisted follow-up worker.
...
- **Integration evidence:** https://tend.tangvu.dev/evidence
